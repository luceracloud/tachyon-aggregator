...
var total = 0;
var max = 0;
var waitTimeCreate = 40;
var waitTimeComplete = 25;
var counts = 0;
var stand = new Array();
var multi = new Array();
var types = new Array();
...
{
  if(timeArr[deet].substring(0,2) == n1.substring(0,2))
   {
    place = (parseInt(deet) + 2) % 24;
    break;
   }
}
  ...
  for(var str in res) {
    if(str.substring(0,3) == section) {
      ...
      if (pos == keys.length -1) {
          ...
          else if(n1.substring(0,5) == n2.substring(0,5)) {
          end();
          }
          else {
          funToDo(begin);
